  ...
  <div class="profile-form">
    <el-card>
      ...
      <div class="form-content">
        <el-form v-if="currentStep === 0" :model="formData.basic_info" label-width="120px">
          <el-row :gutter="20">
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="性别">
                <el-select v-model="formData.basic_info.gender" placeholder="请选择性别">
            ...
            <el-col :span="12">
              <el-form-item label="所在地">
                <el-input v-model="formData.basic_info.location" placeholder="请输入所在地" />
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
...
const validateStep = (step: number): boolean => {
  switch (step) {
    case 0:
      return !!formData.value.basic_info.name && !!formData.value.basic_info.email
    case 1:
